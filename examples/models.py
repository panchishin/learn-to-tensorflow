...
class simple0:
    ...
    def convolve(self, image, training,  keep_prob):
        return layer.conv(image, 1, 10, width=28, padding="VALID")


class simple1:

    def convolve(self, image, training,  keep_prob):
        result = layer.conv(image, 1, 18, width=5, stride=2, padding="VALID")
...
class simple2:
    ...
    def convolve(self, image, training,  keep_prob):
        result = layer.conv_relu(image, 1, 18, width=5, stride=2, padding="VALID")
        return layer.conv(result, 18, 10, width=12, padding="VALID")
...
class simple3:
    ...
    def convolve(self, image, training,  keep_prob):
        result = layer.conv_relu(image, 1, 18, width=5, stride=2, padding="VALID")
        result = layer.conv(result, 18, 10, width=11, padding="VALID")
        return layer.avg_pool(result)
...
class simple4:
    ...
    def convolve(self, image, training,  keep_prob):
        ...
        result = layer.conv_relu(result, 1, 18, width=5, stride=2, padding="VALID")
        return layer.conv(result, 18, 10, width=12, padding="VALID")
...
class simple6:
    ...
    def convolve(self, image, training,  keep_prob):
        ...
        result = layer.conv_relu(result, 18, 24, width=5, padding="VALID")
        result = layer.max_pool(result)  # 4
        return layer.drop_conv(keep_prob, result, 24, 10, width=4, padding="VALID")
...
class simple7:
    ...
    def convolve(self, image, training,  keep_prob):
        ...
        return layer.drop_conv(keep_prob, result, 24, 10, width=7, padding="VALID")
...
class simple12:
    ...
    def convolve(self, image, training,  keep_prob):
        ...
        result = layer.resnet_narrow(result, 32, 3, training)
        return layer.drop_conv(keep_prob, result, 32, 10, width=3, padding="VALID")
...
class simple13:
    ...
    def convolve(self, image, training,  keep_prob):
        result = layer.batch_normalization(image, training)
        result = layer.conv_relu(result, 1, 18, width=3)
        result = layer.max_pool(result)  # 14
        result = layer.conv_relu(result, 18, 24, width=3)
        result = layer.max_pool(result)  # 7
        return layer.drop_conv(keep_prob, result, 24, 10, width=7, padding="VALID")
...
class simple16:
    ...
    def convolve(self, image, training,  keep_prob):
        ...
        result = layer.conv_relu(result, 18, 24, width=5)
        result = layer.max_pool(result)  # 7
        result = layer.conv_relu(result, 24, 32, width=5)
        result = layer.max_pool(result)  # 4
        result = tf.nn.dropout(result, keep_prob)
        return layer.conv(result, 32, 10, width=4, padding="VALID")
...
class simple17:
    ...
    def convolve(self, image, training,  keep_prob):
        result = layer.batch_normalization(image, training)
        result = layer.conv_relu(result, 1, 18, width=5)
        result = layer.resnet_narrow(result, 18, 3, training)
        result = layer.max_pool(result)  # 14
        result = layer.resnet_narrow(result, 18, 3, training)
        result = layer.conv_relu(result, 18, 24, width=5)
        result = layer.resnet_narrow(result, 24, 3, training)
...
class simple18:
    ...
    def convolve(self, image, training,  keep_prob):
        result = layer.batch_normalization(image, training)
        result = layer.conv_relu(result, 1, 18, width=5)
        result = layer.resnet_block(result, 18, 3, training, momentum=0.9)
        result = layer.max_pool(result)  # 14
        result = layer.resnet_block(result, 18, 3, training, momentum=0.9)
        result = layer.conv_relu(result, 18, 24, width=5)
        result = layer.resnet_block(result, 24, 3, training, momentum=0.9)
        result = layer.max_pool(result)  # 7
        result = layer.resnet_block(result, 24, 3, training, momentum=0.9)
        result = layer.conv_relu(result, 24, 32, width=5, padding="VALID")
        result = layer.resnet_block(result, 32, 3, training, momentum=0.9)
        result = tf.nn.dropout(result, keep_prob)
        return layer.conv(result, 32, 10, width=3, padding="VALID")
...
class conv_pool_with_msra:
    ...
    def convolve(self, image, training, keep_prob):
        ...
        for index in range(len(layers) - 1):
            result = layer.conv_relu(result, layers[index], layers[index + 1], conv_window)
            result = layer.resnet_block(result, layers=layers[index + 1], width=conv_window, training=training)
            result = layer.resnet_block(result, layers=layers[index + 1], width=conv_window, training=training)
            result = layer.max_pool(result)
            width = int(round(width / 2.0))

        result = layer.conv_relu(result, layers[-1], feature_layer_size, width=width, padding='VALID')
